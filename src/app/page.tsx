...
export default function Home() {
  ...
  const handleCreateCeremony = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After creating a ceremony, jump straight to the two-choice actions screen.
      router.push(`/ceremony/${data.id}/actions`);
    } catch (error) {
              ...
              <div className="space-y-4">
                {ceremonies.map((ceremony) => (
                  ...
                  >
                    ...
                    <div className="mt-4">
                      <Link
                        href={`/ceremony/${ceremony.id}/actions`}
                        className="block w-full px-4 py-3 bg-accent-gold text-white text-base font-semibold rounded-lg text-center hover:opacity-90 transition-opacity"
                      >
                        式典を開く →
                      </Link>
